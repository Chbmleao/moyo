...
import { listDocuments, getDocument, type DocumentItem } from "@/lib/api/documents";
	...
	return (
		<main className="min-h-[calc(100vh-4rem)] px-6 py-16 lg:px-12">
			<div className="mx-auto max-w-3xl">
				<h1 className="text-2xl font-semibold text-foreground">Documentos para assinar</h1>
				<p className="mt-2 text-muted-foreground">Documentos que seu profissional enviou para você assinar.</p>
				...
				{loading ? (
					...
					<p className="mt-6 text-sm text-muted-foreground">Nenhum documento pendente no momento.</p>
				) : (
							...
							<li
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										{doc.deadlineAt ? `Prazo: ${new Date(doc.deadlineAt).toLocaleDateString("pt-BR")}` : "Sem prazo"}
