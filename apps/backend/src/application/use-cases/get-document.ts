...
export type GetDocument = (documentId: string, user: User) => Promise<GetDocumentResult | null>;

export function makeGetDocument(
	documentRepository: DocumentRepository,
	storageRepository: StorageRepository,
): GetDocument {
	return async function getDocument(documentId: string, user: User): Promise<GetDocumentResult | null> {
